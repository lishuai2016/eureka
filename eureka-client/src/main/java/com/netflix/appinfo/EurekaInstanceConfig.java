...
public interface EurekaInstanceConfig {
     ...
     *
     * 这段的意思是，是不是应该在注册完成后立即开始工作？还是稍等下再工作？【take traffic具体何意？？？】
     *
     ...
     *
     * 这个参数的含义是：
     * client在注册到server后需要与server保持心跳检测，在指定的时间内没有发送心跳消息，server
     * 就判断当前client不在存活，移除自己的列表
     *
     * 这个client可能是服务提供者或者消费者？？？
     *
     *
     * 租约续约频率，单位：秒。
